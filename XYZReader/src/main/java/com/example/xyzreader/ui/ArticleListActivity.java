...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) findViewById(R.id.article_list_root);

        snackbar = Snackbar
                .make(coordinatorLayout, getText(R.string.no_connection), Snackbar.LENGTH_INDEFINITE)
